...
##title##
title=makeLabel("The Encryptinator", 80,370,0,WHITE,font="Ariel")
showLabel(title)
###choice text###
msg1=makeLabel("Encryptor or Decryptor?", 80,330,350,WHITE,font="Ariel")
dec = makeLabel("Type in the Encrypted password to Decrypt", 50,330,350,WHITE,font="Ariel")
showLabel(msg1)
###enc text###
...
#encription portion  
  enc=makeLabel("Type in a password to start the Encryption", 50,330,350,WHITE,font="Ariel")
  showLabel(enc)
  hideLabel(msg1)
    ...
    if encryptLetter == "u":
      ...
      for e in range (26):
        if encryptLetter == (alphabet1[e]):
          encryptedPassword = str(encryptedPassword +(alphabet1[e+3]))
          print("Encrypting: "+encryptLetter)
          time.sleep(0.1)
          print("Password is: "+encryptedPassword)
          time.sleep(0.1)
          ...
          encryptedPassword = str(encryedPassword +(alphabet2[e+3]))
          print("Encrypting: "+encryptLetter)
          time.sleep(0.1)
          print("Password is: "+encryptedPassword)
          time.sleep(0.1)
      ...
      for e in range (10):
        if encryptLetter == (numbers[e]):
          encryptedPassword = str(encryptedPassword +(numbers[e+3]))
          print("Encrypting: "+encryptLetter)
          time.sleep(0.1)
          print("Password is: "+encryptedPassword)
          time.sleep(0.1)
      ...
      for e in range (26):
        if encryptLetter == (characters[e]):
          encryptedPassword = str(encryptedPassword +(characters[e+3]))
          print("Encrypting: "+encryptLetter)
          time.sleep(0.1)
          print("Password is: "+encryptedPassword)
          time.sleep(0.1)
    ...
    if encryptLetter == "x":
      ...
      for e in range (26):
            if encryptLetter == (alphabet2[e]):
              encryptedPassword = str(encryptedPassword +(alphabet2[e-3]))
              print("Decrypting: "+encryptLetter)
              time.sleep(0.1)
              print("Password is: "+encryptedPassword)
              time.sleep(0.1)
...
#output portion 
pswd=makeLabel("Your password is: "+encryptedPassword, 80,360,450,WHITE,font="Ariel")
showLabel(pswd)
